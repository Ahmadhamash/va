...
SAFE_RESPONSES = {
    "product_not_found": "المعلومة مش واضحة عندي هسه. ابعتلي اسم المنتج أو صورته وبشيكلك عليه.",
    "product_unavailable": "هذا المنتج مش متوفر حالياً.",
    "price_unknown": "خليني أتأكدلك من السعر الحالي، وبحوّلك للفريق يعطيك السعر الأدق 🙏",
    "uncertain": "خليني أتأكدلك من المعلومة الأدق وبرد عليك بأوضح جواب.",
    "hallucination_blocked": "خليني أتأكدلك من المعلومة الأدق، وبحوّلك للفريق يساعدك أكثر 🙏",
    "verification_unavailable": "خليني أتأكدلك من المعلومة الأدق، وبحوّلك للفريق يساعدك أكثر 🙏",
    "handoff": "أكيد، ولا يهمك 🙏 رح أحوّلك لموظف من الفريق يساعدك بشكل أدق.",
    "off_topic": "خلينا بمنتجاتنا وخدماتنا أحلى. إذا بتحب، بقدر أساعدك تختار أو أبعثلك الخيارات المتوفرة.",
}
