...
export default function BookingsPage() {
  ...
  return <div className="py-7" dir="rtl">
    <div className="app-container space-y-6">
      <h1 className="text-xl font-black text-gray-950 dark:text-white sm:text-2xl">{t("txt_13")}</h1>
      ...
      {tab === "slots" && <div className="space-y-4">
        ...
        {showSlotForm && <form onSubmit={addSlot} className="surface p-5 sm:p-6 space-y-4">
      ...
      {tab === "bookings" && <div className="space-y-3">
        {loading ? <p className="text-gray-500">{t("txt_26")}</p> : bookings.length === 0 ? <p className="text-gray-500 text-center py-10">{t("txt_27")}</p> : bookings.map(b => <div key={b.id} className="surface p-5">
