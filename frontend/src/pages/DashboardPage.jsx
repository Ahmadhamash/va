...
const journeyCards = [
  ...
  },
  {
    to: "/training",
    icon: Sparkles,
    title: "شخصية الذكاء الاصطناعي",
    text: "تحديد مستوى الرسمية، اللهجة، والمصطلحات ليتحدث الذكاء الاصطناعي بأسلوبك.",
    action: "تخصيص الشخصية",
  },
  {
    to: "/handoff",
    icon: UserCheck,
  ...
  },
  {
    ...
    text: "إدارة أوقات العمل والمواعيد المتاحة ليحجز العميل مباشرة.",
    action: "إعداد الحجوزات",
  },
  {
    to: "/delivery",
    icon: Truck,
    title: "قواعد التوصيل",
    text: "تحديد مناطق التوصيل، التكاليف، والمدة ليجيب المساعد بدقة.",
    action: "إدارة التوصيل",
  },
  {
    to: "/policies",
    icon: ScrollText,
    title: "السياسات العامة",
    text: "الاسترجاع، الاستبدال، والضمان. كل ما يحتاجه المساعد من قواعد.",
    action: "إضافة السياسات",
  },
  {
    to: "/offers",
    icon: BadgePercent,
    title: "العروض والباقات",
    text: "إنشاء العروض الخاصة والباقات ليعرضها المساعد على العملاء.",
    action: "إدارة العروض",
  },
  {
    to: "/payments",
    icon: CreditCard,
    title: "إعدادات الدفع",
    text: "طرق الدفع المتاحة، الحسابات البنكية، والأسعار.",
    action: "تكوين الدفع",
  },
];
...
export default function DashboardPage() {
  ...
  async function handleSearch(e) {
    ...
    try {
      ...
      alert(err?.response?.data?.detail || "فشل البحث");
    }
  }
  ...
  async function handleCreate(payload) {
    try {
      ...
      alert(err?.response?.data?.detail || "فشل الإضافة");
    }
  }
  ...
  async function handleUpdate(payload) {
    try {
      ...
      alert(err?.response?.data?.detail || "فشل التعديل");
    }
  }
  ...
  async function handleToggle(item) {
    try {
      ...
      alert(err?.response?.data?.detail || "فشل التفعيل/الإيقاف");
    }
  }
