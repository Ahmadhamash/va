          ...
          <main className="surface p-5 sm:p-6">
            {!selected ? (
              ...
              <div className="space-y-5">
                ...
                <div className="rounded-lg border border-mint-100 bg-mint-50 p-4 dark:border-mint-500/20 dark:bg-mint-500/10">
                  <div className="mb-2 text-sm font-black text-mint-800 dark:text-mint-200">الرد المقترح للعميل</div>
                  <p className="text-sm leading-7 text-mint-900 dark:text-mint-100">
