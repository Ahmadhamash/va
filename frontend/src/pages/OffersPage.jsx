...
export default function OffersPage() {
  ...
  return <div className="py-7" dir="rtl">
    <div className="app-container space-y-6">
      <h1 className="text-xl font-black text-gray-950 dark:text-white sm:text-2xl">{t("txt_108")}</h1>
      ...
      {tab === "offers" && <>
        ...
        {showForm && <form onSubmit={submitOffer} className="surface p-5 sm:p-6 space-y-4">
        ...
        {!loading && <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">{offers.map(o => <div key={o.id} className="surface p-5">
      ...
      {tab === "packages" && <>
        ...
        {showForm && <form onSubmit={submitPkg} className="surface p-5 sm:p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
        ...
        {!loading && <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">{packages.map(p => <div key={p.id} className="surface p-5">
